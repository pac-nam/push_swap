...
/*   Updated: 2018/03/21 16:13:11 by tbleuse          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_printf_b_rest(char *str, int *info)
{
	int		len;
...
int				ft_printf_b(unsigned long long nb, int *info)
{
	int		count;
	char	*str;
	...
	if (info[2] == -1)
		count += ft_printf_b_rest(str, info);
	ft_putstr(str);
